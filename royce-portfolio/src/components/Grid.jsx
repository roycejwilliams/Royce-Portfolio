          ...
          <div className='grid  lg:grid-cols-3 lg:gap-x-2 gap-y-3 '>
              ...
              <div className='bg-gradient-to-b from-black via-black/70 to-white/20 rounded-lg shadow-xl backdrop-blur lg:row-span-2 border lg:w-none lg:h-none flex items-center w-full h-full'>
                <ul className='lg:w-5/6 lg:h-5/6 w-11/12 h-5/6 font-azeret text-white m-4 flex flex-col justify-between text-sm uppercase'>
                  <h2 className='text-lg  font-clash tracking-widest font-bold'>My Skills</h2>
                  <li className="flex items-center text-xxs"><span>UX/UI</span><hr className="flex-grow border-t border-gray-300 ml-2" /></li>
                  <li className="flex items-center text-xxs"><span>Branding</span><hr className="flex-grow border-t border-gray-300 ml-2" /></li>
                  <li className="flex items-center text-xxs"><span>Marketing</span><hr className="flex-grow border-t border-gray-300 ml-2" /></li>
                  <li className="flex items-center text-xxs"><span>Product Design</span><hr className="flex-grow border-t border-gray-300 ml-2" /></li>
                  <li className="flex items-center text-xxs"><span>Strategic Design</span><hr className="flex-grow border-t border-gray-300 ml-2" /></li>
                  <li className="flex items-center text-xxs"><span>Consumer Research</span><hr className="flex-grow border-t border-gray-300 ml-2" /></li>
                  <li className="flex items-center text-xxs"><span>Web Development/Design</span><hr className="flex-grow border-t border-gray-300 ml-2" /></li>
                </ul>
              </div>
              {/* Social Media */}
              <div className='bg-black rounded-lg shadow-xl flex justify-center w-full h-auto'>
              ...
              {/* Mission */}
              <div className='bg-black rounded-lg shadow-xl flex justify-center w-full'>
                  ...
                  {/* <div className='w-3/5 h-full flex flex-col justify-center overflow-hidden'>
                    ...
                    {sounds.map((slide, index) => (
                        <iframe 
                          ...
                          height="100%"
                          key={index}
                          style={{ maxWidth: '500px', maxHeight:'200px', overflow: 'hidden', borderRadius: '10px', padding: '0 5px' }}
                          src= {slide}
                        >
                        </iframe>
                    )) }
