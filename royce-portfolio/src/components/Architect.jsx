    ...
    <div>
        <div className='h-screen w-full bg-black'>
            <div className='w-full h-36 flex items-center'>
                <div className='h-16 w-10/12 flex bg-rosered justify-end items-center'>
                    <h2 className='text-white text-5xl uppercase font-clash mr-4'>Architecture</h2>
                </div>
            </div>
            
                <div className='w-5/6 h-4/5 flex justify-between'>
                    <div className='h-full w-3/6 ml-4 flex gap-4'>
                     ...
                     <div className='w-2/6 h-auto text-white font-azeret flex justify-center items-center'>
