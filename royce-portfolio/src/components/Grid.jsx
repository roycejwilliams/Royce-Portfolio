...
const Grid = () => {
  ...
  const href = [
    "https://twitter.com/roycwilliams",
  ...
  return (
    <div className="bg-rosered min-h-screen w-full flex justify-center items-center">
      <div className="w-full md:w-5/6  grid grid-cols-1 gap-y-2 sm:grid-cols-3 md:gap-x-2 md:gap-y-3 p-4">
        {/* Skills */}
        <div className="bg-gradient-to-b flex-col p-4 from-black via-black/70 to-white/20 col-span-3 rounded-lg shadow-xl backdrop-blur xl:col-span-2 xl:row-span-3 border md:w-none  md:h-none flex w-full h-full">
          <div className="w-full  flex items-center">
            <h2 className="uppercase text-lg lg:text-3xl font-clash tracking-widest ml-4 font-bold text-white">
              Skills
            </h2>
          </div>
        ...
        {/* Social Media */}
        <div className="bg-black rounded-lg shadow-xl w-full h-auto col-span-3 xl:col-span-1 p-4">
          <div className="w-full  flex items-center">
            <h2 className="uppercase text-sm lg:text-xl font-clash tracking-widest ml-4 font-bold text-white">
              socials
            </h2>
          </div>
            ...
            <ul className="w-full h-full mx-auto flex flex-wrap justify-center md:justify-evenly items-center gap-x-4 md:gap-2 ">
              {logoFiles.map((logo, index) => (
                <a href={href[index]}>
                  <li
                    key={index}
                    className="bg-gray-800 w-8 h-8  xl:w-12 xl:h-12 rounded-xl hover:scale-75 transition ease-in 800s hover:shadow-xl hover:shadow-white"
                  >
        ...
        {/* Mission */}
        <div className="bg-black rounded-lg shadow-xl flex flex-col col-span-3 xl:col-span-1 xl:row-span-3 items-center justify-center w-full p-4">
          <div className="w-full block">
            ...
            <p className="font-azeret text-xxs text-white md:text-xs xl:text-fit ml-4 tracking-wider max-h-[100%]">
              Actively contributing to initiatives that foster positive impacts.
              I engineer and cultivate sustainable products that transcend
              accessibility barriers. My longevity aiming to make a lasting,
              meaningful difference for all.
            </p>
          </div>
        </div>
        {/* Apple Music - Rotation */}
        <div className="bg-black rounded-lg shadow-xl hidden xl:visible col-span-2 xl:flex p-4">
          <div className="w-2/5  hidden lg:flex lg:visible">
            {/* apple music logo */}
          ...
          <div className="w-full h-auto flex items-center overflow-hidden relative">
            <div
              className="flex xl:w-[50%] w-[60%] h-auto mx-auto transition ease-in duration-150"
            ...
            <div className="w-full absolute h-auto flex gap-x-60 justify-between items-center">
              <button
                onClick={handlePrev}
                className="w-10 h-10 hover:bg-gray-400  bg-slate-800 rounded-full flex items-center justify-center transition ease-in duration-800 animate-carousel-left"
                style={{ top: "50%" }}
              >
                <FontAwesomeIcon
                  icon={faChevronLeft}
              ...
              <button
                ...
                className="w-10 h-10 hover:bg-gray-400 bg-slate-800 rounded-full flex items-center justify-center transition ease-in duration-800 animate-carousel-right"
                style={{ top: "50%" }}
              >
                <FontAwesomeIcon
                  icon={faChevronRight}
        ...
        {/* Tools */}
        <div className="bg-black rounded-lg shadow-xl col-span-3 flex justify-center items-center p-4">
          <div className="flex justify-center w-1/2  text-white items-center font-clash uppercase">
            <h2 className="text-xl lg:text-5xl font-bold tracking-widest">
              tech stack
            </h2>
          </div>
          <div className="inline-flex flex-nowrap w-1/2  text-white items-center font-clash uppercase overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
            <ul
              id="logos"
              className="flex items-center justify-center md:justify-start [&_li]:mx-8 animate-slide-left"
            >
