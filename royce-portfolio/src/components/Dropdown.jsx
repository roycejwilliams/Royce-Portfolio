...
const Dropdown = () => {
  ...
  return (
    <div className="relative lg:inline-block hidden lg:visible text-left  h-full xl:flex justify-center items-center xl:flex-col">
      ...
      <span className="text-m tracking-widest text-white font-clash font-medium uppercase text-xs md:text-md">Interest ? </span>
      ...
      {/* Second Section */}
      <div className='flex w-full justify-start items-center px-4'>
      <span className="text-m tracking-widest text-white font-clash font-medium uppercase text-xs md:text-md">Based ? </span>
