...
const Bio = () => {
  return (
    <>
      <div className='bg-gray-300 w-full h-500'>
        {/* Intro */}
        <div className='flex flex-col w-full justify-between items-center h-full '>
          {/* Title */}
            <div className='w-full h-2/4 flex flex-col justify-end items-start'>
              <div className='w-1/2 ml-4 h-auto  flex flex-col '>
                <h2 className='text-rosered text-8xl font-clash'>Royce Williams</h2>
                <p className='font-azeret text-sm text-black'>Computer Engineer & Founder of REVITAL</p>
              </div>
            </div>
          {/* Bio */}
            <div className='w-full h-3/5 flex justify-end items-center'>
                <div className='w-2/3 h-full flex flex-col items-center justify-center'>
                  ...
                  {/* Contact Button */}
                  <button onClick={handleEmailClick} className="font-clash p-4 flex w-full h-auto mt-4 text-gray-100 text-2xl font-regular hover:text-black cursor-pointer tracking-wide group">
                    <span >Reach Out.</span>
      ...
      <div className='h-screen w-full bg-gray-300 flex'>
          <div className='w-1/2 h-full flex justify-center mt-4'>
            <div className='w-full ml-4 h-auto'>
              <h2 className='font-clash text-9xl text-rosered'>Here to Support You With</h2>
            </div>
          </div>
          <div className='w-1/2 h-full flex justify-center items-center'>
            <div className='w-3/4 h-2/3 flex flex-col justify-evenly items-center'>
              <div className='w-3/4 h-28 text-black font-azeret'> 
              ...
              <div className='w-3/4 h-28 text-black font-azeret'>
                <h1 className='w-full text-2xl '> <div className='w-4 h-4 text-sm flex items-center justify-center border-black border rounded-full'>2</div>  Development</h1>
              ...
              <div className='w-3/4 h-28  text-black font-azeret'>
                ...
                <div className='w-4 h-4 text-sm flex items-center justify-center border-black border rounded-full'>3</div> 
                  Full Package</h1>
                  <p className='text-xs'>What sets me apart is my ability to take your idea from concept to reality, providing a comprehensive solution from start to finish.</p>
              </div>
            </div>
          </div>
      </div>  
      ...
      <div className=' w-full bg-gray-300 flex flex-col min-h-screen items-center justify-center font-bold text-white'>
              <div className="text-center text-8xl text-rosered font-clash font-regular">
              <Navbar /> Building..
